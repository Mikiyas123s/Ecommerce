    ...
    <div>
        <div className='max-w-screen-xl mx-auto my-10 flex gap-10'>
            <div className='w-2/5 relative'>
                <img className='w-full h-[550px] object-cover' src={details.image} alt="fuck off" />
        ...
        <div className='w-3/5 flex-col justify-center gap-12'>
            ...
            <p className='font-semibold'>${details.price}</p></div>
         
               <br></br> <br></br> <br></br>
                <div className='flex items-center gap-4 mt-3'>
                <p className='text-base text-gray-500 -mt-3'>{details.description}</p><br></br><br></br>
                </div> </div>
